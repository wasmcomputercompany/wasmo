...
/**
 * Write generated-dom-tester.js to the current project's karma.config.d directory.
...
internal abstract class WriteSnapshotTestingJsTask : DefaultTask() {
  ...
  @TaskAction
  fun task() {
    val sourcePath = "/com/wasmo/domtester/gradle/generated-dom-tester.js".toPath()
    val targetPath = karmaConfigD.file("generated-dom-tester.js")
