...
public class StripeCustomerQueries(
  ...
  public fun insertStripeCustomer(
    ...
    country: String,
    postal_code: String,
  ): ExecutableQuery<StripeCustomerId> = InsertStripeCustomerQuery(
    created_at,
    version,
    stripe_customer_id,
    name,
  ...
  public fun findStripeCustomerByStripeCustomerId(stripe_customer_id: String): Query<StripeCustomer> =
    findStripeCustomerByStripeCustomerId(stripe_customer_id, ::StripeCustomer)
